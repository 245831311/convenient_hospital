...
public class RedisUtil {
    ...
    public static JedisPool getPool() {  
    	if (pool == null) {
    		String ip = ResourcesUtil.getValue(
    				AppConstants.COMMON_PROPERTIES,AppConstants.REDIS_IP);
    		int port = Integer.parseInt(ResourcesUtil.getValue(
    				AppConstants.COMMON_PROPERTIES,AppConstants.REDIS_PORT));
