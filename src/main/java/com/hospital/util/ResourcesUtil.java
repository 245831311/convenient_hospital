...
public class ResourcesUtil implements Serializable {
	 ...
	 * @return
	 */
	public static String getRedisKey(HttpServletRequest request, String appKey) {
		String sessionId = request.getSession().getId();
		return ResourcesUtil.getValue(
				AppConstants.COMMON_PROPERTIES, appKey, new Object[]{sessionId});
	}
	
	/**
	 * 根据sessionKey 获取sessionValue
	 * 
	 * @author yubing
	 * @param request
	 * @param sessionKey
	...
	public static void main(String[] args) {
		System.out.println(getValue("common", "redis.agendas", new Object[] {"bing"}));
		System.out.println(getValue("common", "redis.ip"));
