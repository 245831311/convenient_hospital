...
public class ParticipantDao extends MybatisBaseDao<Object,String>{
	...
	public boolean batchInsertParticipants(List<Participant> participants) throws ServiceException{
		try {
			getSqlSession().insert(getSqlName("batchInsertParticipants"), participants);
		} catch (Exception e) {
			throw new ServiceException("UserDao.batchInsertParticipants occur exception!", e, Code.CODE_SERVER_ERROR, "");
		}
